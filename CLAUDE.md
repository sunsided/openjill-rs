...
This project is indexed by GitNexus as **openjill-rs** (6896 symbols, 18738 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
