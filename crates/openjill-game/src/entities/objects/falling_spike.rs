...
//! reference: a spike pinned to the ceiling that falls when triggered and
//! kills the player on contact.
//!
//! Only the lethal-touch contract is modelled here; the trigger and the
//! downward motion land alongside the rest of the hazard-movement pass once
//! the SHA tile identity is verified against `JILL1.SHA`.
