...
mod tests {
    ...
    fn dump_writes_jn_payload_metadata_with_deterministic_discovery_order() {
        ...
        write_valid_episode_one_fixture(temp_dir.path());
        fs::write(temp_dir.path().join("Intro.Jn1"), valid_jn_dump_bytes()).expect("write Intro.Jn1");
        ...
        fs::write(temp_dir.path().join("alpha.JN1"), valid_jn_dump_bytes()).expect("write alpha.JN1");
    ...
    fn dump_jn_reports_parser_errors_with_file_context() {
        ...
        write_valid_episode_one_fixture(temp_dir.path());
        fs::write(temp_dir.path().join("BADLEVEL.jn1"), [0u8; 4]).expect("write malformed BADLEVEL.jn1");
